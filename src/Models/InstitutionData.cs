...
public record InstitutionRecord(
    ...
    [property: JsonProperty("numOfSharesBoughtByInstitutions", NullValueHandling = NullValueHandling.Ignore)] int? NumOfSharesBoughtByInstitutions,
    [property: JsonProperty("numOfSharesSoldByInstitutions", NullValueHandling = NullValueHandling.Ignore)] int? NumOfSharesSoldByInstitutions,
    [property: JsonProperty("changeInSharesHeldByInstitutions", NullValueHandling = NullValueHandling.Ignore)] int? ChangeInSharesHeldByInstitutions,
